...
class PMP_Public {
    ...
    public static function init() {
        ...
        add_action( 'wp_ajax_pmp_filter_gallery',            [ __CLASS__, 'ajax_filter_gallery' ] );
        add_action( 'wp_ajax_nopriv_pmp_filter_gallery',     [ __CLASS__, 'ajax_filter_gallery' ] );
        add_action( 'wp_ajax_pmp_get_filter_options',        [ __CLASS__, 'ajax_get_filter_options' ] );
        add_action( 'wp_ajax_nopriv_pmp_get_filter_options', [ __CLASS__, 'ajax_get_filter_options' ] );
